...
class UserProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Listeners
        backButton.setOnClickListener {  // Crear una intención explícita para abrir MainActivity
            val intent = Intent(this, MainActivity::class.java)
            // Iniciar la actividad
            startActivity(intent)
            // Opcional: Finaliza la actividad actual para que el usuario no pueda regresar a esta pantalla
            finish() }
